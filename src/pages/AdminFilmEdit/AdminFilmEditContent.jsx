...
import './AdminFilmEditContent.scss';

function AdminFilmEditContent() {
  return (
    <div className="film-edit">
      <label htmlFor="film-selector" className="film-edit__selector-label">
        Выберите фильм
        <select className="film-edit__selector" name="film-editor" id="film-selector">
          <option value="1" className="film-edit__option">Пираты карибского моря</option>
          <option value="2" className="film-edit__option">Пиры карибианского мора</option>
          <option value="3" className="film-edit__option">Элден, сука, ринг</option>
        </select>
      </label>
      ...
      <form onSubmit={() => {}} className="form">
        ...
        <Button title="Редактировать" action={() => {}} />
      </form>
    </div>
  );
}

export default AdminFilmEditContent;
